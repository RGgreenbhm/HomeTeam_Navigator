...
- `workspace-setup.md` - Installation guide for new workspaces
...
1. Copy the entire `..Workspace/Settings/` folder to new workspace
2. Run the setup script: `.\setup-workspace.ps1` (see workspace-setup.md)
3. Or manually copy slash commands from `teams/*/commands/` to `.claude/commands/`
